...
$id = $_GET["id"];
$konten = mysqli_query($conn, "SELECT * FROM table_data_input WHERE ID= '$id'");
...
function ubah($data)
{
  ...
  $create = $data["create_by"];
  $content = $data["content"];

  $query = "UPDATE table_data_input SET 
            title = '$title',
            sub_title = '$sub_title',
            create_by = '$create',
            content = '$content'
        ...
        <div class="container-fluid">
          ...
          <div class="ml-5 mr-5">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <p class="display-4 mt-4ml-5">Form Ubah Data</p>
            </div>
            <form action="" method="post">
              ...
              <div class="input-group flex-nowrap">
                ...
                <input value="<?= $result["ID"] ?>" name="id" type="text" class="form-control" placeholder="Masukan ID..." aria-label="Username" aria-describedby="addon-wrapping">
              </div>
              ...
              <div class="input-group flex-nowrap pt-4">
                ...
                <input value="<?= $result["create_by"] ?>" name="create_by" type="text" class="form-control" placeholder="Masukan create-by..." aria-label="Username" aria-describedby="addon-wrapping">
              </div>

              <!--content-->
              <div class="input-group flex-nowrap pt-4">
                <textarea name="content" type="text" class="form-control" placeholder="Masukan articel..." aria-label="Username" aria-describedby="addon-wrapping"><?= $result["content"] ?></textarea>
              </div>

              <!--Button-->
              <div>
                <button name="submit" type="submit" class="btn btn-primary mt-4">Ubah</button>
                <button type="submit" class="btn btn-success mt-4"><a href="input.php" class="text-white">Kembali</a></button>
              </div>
          </div>
          </form>
          <br> 
